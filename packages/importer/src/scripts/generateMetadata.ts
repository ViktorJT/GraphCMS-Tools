import {SchemaType, MetadataType} from '../types/index.js';

export const generateMetadata = (schema: SchemaType): MetadataType => {
  ...
  if (!defaultLocale) throw Error('No default locale found, please check your GraphCMS settings');
